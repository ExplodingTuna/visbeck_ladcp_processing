...
% load CTD-time file
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data = ctdtimeload(files,data,ctd_lag);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function ndata = ctdtimeload(files,ndata,ctd_lag);
%
...
if exist(files.ctdtime,'file')==0
  ...
  load(files.ctdtime);
%keyboard  
  % modified by R.Smith to ask for time shift correction:
% 6/8/2007
% 
%% modified again by R.Smith in April 2014 to allow for batch processing 
% ctd_time_shift = input('Enter CTD time shift (in seconds):');
 disp(['CTD time shifted by ',int2str(ctd_lag),' seconds prior to processing.']);
 ctd_time_shift = ctd_lag;
% 
 ctd_time_shift = ctd_time_shift / 86400;
% 
 timctd = timctd + ctd_time_shift;
%
% end Ryan modification
